                    ...
                    <div class="row">
                        ...
                        <form>
                            <div class="card-holder">
                                    <input type="text" placeholder="Nome Titular do Cartão" id="card-name" class="card-name" />
                                    <div id="card-element" class="card-element">
                                        <div class="form-group">
                                            <label for="card_number">Número do Cartão</label>
                                            <input type="text" class="form-control" id="card_number" data-stripe="number" placeholder="Número Cartão">
                                        </div>
                                        <div class="form-row">
                                            <label>
                                                <span> Número Cartão </span>
                                                <input type="text" size="20" data-stripe="number" placeholder="Número Cartão">
                                            </label>
                                        </div> 
                                    
                                        <div class="form-row">
                                        <label>
                                            <span>Expira (MM/YY)</span>
                                ...
                                <div class="pay-btn">
                                    <input type="submit" class="btn btn-info btn-lg" value="Pagar" />
                                </div>
