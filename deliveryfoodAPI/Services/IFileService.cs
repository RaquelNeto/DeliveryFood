...
namespace deliveryFoodAPI.Services
{
    ...
    {
        string newNameFiles(string nomeArquivo, string extensao, string id);
        Dictionary<string, string> GetMimeTypes();
    }

    public class FileService : IFileService
    {
        public string newNameFiles(string nameFile, string extensao, string id)
        {
